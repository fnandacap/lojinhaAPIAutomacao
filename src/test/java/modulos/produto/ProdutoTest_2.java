...
public class ProdutoTest_2 {
    ...
    given()
                ...
                .body(ProdutoDataFactory.criarProdComumValorIgualA(0.00))
            .when()
                .post("/v2/produtos")
            .then()
                .assertThat()
    ...
    public void testValidarLimitesMaiorSetMilProibidoValorProduto() {
            given()
                .contentType(ContentType.JSON)
                .header("token", this.token)
                .body(ProdutoDataFactory.criarProdComumValorIgualA(7000.01))
            .when()
                .post("/v2/produtos")
            .then()
                .assertThat()
